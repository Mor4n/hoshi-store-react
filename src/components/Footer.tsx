  ...
  return (
    <footer id="footer">
        <section className="footer-section">
            <h2 className="footer-titulo"> Síguenos en tooodas nuestras redes sociales</h2>
            <ul className="footer-lista">
                ...
                <li><a href="https://www.youtube.com/" target="_blank"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/YouTube_full-color_icon_%282024%29.svg/1280px-YouTube_full-color_icon_%282024%29.svg.png" alt="Imagen de logo de Youtube"/></a></li>
            </ul>
        </section>
