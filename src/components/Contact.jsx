     ...
     <section id="contacto" class="contacto-section">
            ...
            <div class="contacto-form-div">
                <form class="contacto-form">
                    ...
                    <label for="archivo" id="input-arch">Toca aquí para añadir una imagen o archivo</label>
            ...
            <div class="contacto-info">
                <h2>Contacto</h2>
                <p>Si tienes alguna duda respecto a nuestros productos o necesitas soporte técnico por algún pedido, o simplemente, quieres enviarnos una foto para añadirla a la galería, llena el formulario que está aquí a la <span class="hoshi">izquierda</span> o por
